...
const Header: React.FC<HeaderProps> = ({
  ...
  const notifications = [
    ...
    },
    {
      ...
      message: "₵45.67 deposited to account",
      time: "1 hour ago",
      unread: true,
      type: "payment"
    },
    ...
    },
    {
      ...
      message: "September report available",
      time: "1 day ago",
      unread: false,
      type: "report"
    }
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-3 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-xl py-2 z-50 border border-gray-200 dark:border-slate-700 backdrop-blur-sm">
                  ...
                  <button className="block px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors duration-200">
                    Profile Settings
                  </button>
                  <button className="block px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors duration-200">
                    Account Settings
