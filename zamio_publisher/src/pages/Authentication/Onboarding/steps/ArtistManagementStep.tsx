...
const ArtistManagementStep: React.FC<ArtistManagementStepProps> = ({ onNext, onPrevious }) => {
  return (
    <div className="py-8">
      <h3 className="text-2xl font-semibold text-white mb-4">Artist Management</h3>
      <p className="text-slate-300 mb-6">Artist management step placeholder - to be implemented</p>
