...
const mockTrackData = {
  ...
  contributors: [
    { role: 'Producer', name: 'KillBeatz' },
    { role: 'Featured Artist', name: 'Shatta Wale' },
    { role: 'Mixing Engineer', name: 'MikeMillzOnEm' }
  ],
  topStations: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-2xl p-6 border border-gray-200/50 dark:border-slate-700/30 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-md hover:from-purple-700 hover:to-pink-700 transition-all duration-200">
